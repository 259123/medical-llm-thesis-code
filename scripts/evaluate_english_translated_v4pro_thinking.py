...
def evaluate_model_on_medqa(input_file: str, max_examples: int = None) -> None:
    ...
    results_file = f'results_english_translated_v4pro_{timestamp}.csv'
    stats_file = f'stats_english_translated_v4pro_{timestamp}.txt'
    ...
    with open(results_file, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        with open(input_file, encoding='utf-8') as f:
            for line_num, line in enumerate(f):
                ...
                # Format prompt
                prompt = example['translated_question']
                options = example['translated_options']
                ...
                try:
                    ...
                    # Write result to CSV
                    writer.writerow([
                        example['translated_question'],
                        str(example['translated_options']),
                        example['answer_idx'],
                        pred,
                        is_correct,
                        reasoning
    ...
    with open(stats_file, 'w', encoding='utf-8') as f:
        f.write("Evaluation Statistics (English Translated to Chinese)\n")
        f.write("=====================================================\n\n")
...
if __name__ == "__main__":
    # Load and evaluate Chinese MedQA dataset
    dataset_path = "medqa/english_translated_100.jsonl"  # Machine-translated Chinese
    ...
    evaluate_model_on_medqa(dataset_path, max_examples=None)  # Only 5 examples for testing
