...
# Load data
df = pd.read_csv('results_chinese_native.csv')
...
print("=" * 50)
print("Chinese Native - Reasoning Length Statistics (chars)")
print("=" * 50)
...
output_file = 'stats_chinese_native.txt'
with open(output_file, 'w') as f:
    f.write("=" * 50 + "\n")
    f.write("Chinese Native - Reasoning Length Statistics (chars)\n")
    f.write("=" * 50 + "\n")
    f.write(f"\nTotal questions: {len(df)}\n")
