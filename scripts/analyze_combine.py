...
df1 = pd.read_csv('results_english_original.csv')
df2 = pd.read_csv('results_english_translated.csv')
df3 = pd.read_csv('results_chinese_native.csv')
...
print("=" * 50)
print("Combined (All 3 Conditions) - Reasoning Length Statistics (chars)")
print("=" * 50)
...
output_file = 'stats_combined.txt'
with open(output_file, 'w') as f:
    f.write("=" * 50 + "\n")
    f.write("Combined (All 3 Conditions) - Reasoning Length Statistics (chars)\n")
    f.write("=" * 50 + "\n")
    f.write(f"\nTotal questions: {len(df)}\n")
