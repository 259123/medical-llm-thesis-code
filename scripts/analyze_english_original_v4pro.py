...
# Load data
df = pd.read_csv('results_english_original_v4pro.csv')
...
print("=" * 50)
print("English Original V4-Pro - Reasoning Length Statistics (chars)")
print("=" * 50)
...
output_file = 'stats_english_original_v4pro.txt'
with open(output_file, 'w') as f:
    f.write("=" * 50 + "\n")
    f.write("English Original V4-Pro - Reasoning Length Statistics (chars)\n")
    f.write("=" * 50 + "\n")
    f.write(f"\nTotal questions: {len(df)}\n")
