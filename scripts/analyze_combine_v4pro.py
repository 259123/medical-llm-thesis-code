...
df1 = pd.read_csv('results_english_original_v4pro.csv')
df2 = pd.read_csv('results_english_translated_v4pro.csv')
df3 = pd.read_csv('results_chinese_native_v4pro.csv')

# Add a label to track which dataset each row came from
df1['dataset'] = 'English Original'
df2['dataset'] = 'English Translated'
df3['dataset'] = 'Chinese Native'
...
print("=" * 50)
print("Combined V4-Pro (All 3 Conditions) - Reasoning Length Statistics (chars)")
print("=" * 50)
...
output_file = 'stats_combined_v4pro.txt'
with open(output_file, 'w') as f:
    f.write("=" * 50 + "\n")
    f.write("Combined V4-Pro (All 3 Conditions) - Reasoning Length Statistics (chars)\n")
    f.write("=" * 50 + "\n")
    f.write(f"\nTotal questions: {len(df)}\n")
